            ...
            [Bind("OfferId, ArrivalDate, ArrivalTime, DepartureDate, DepartureTime, NbPerson")] Booking booking)
        {
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    TempData["AlertMsg"] = "You do not have the amount necessary to proceed with the reservation, you are missing" + (totalPrice - senderUser.Balance) + " Tk ! Please <a href=\"/Identity/Account/Manage/Wallet\">credit your account</a>";
